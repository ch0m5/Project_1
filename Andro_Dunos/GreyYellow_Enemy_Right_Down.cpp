...
GreyYellow_Enemy_Right_Down::GreyYellow_Enemy_Right_Down(int x, int y) : Enemy(x, y)
{
	hitboxWidth = 29;
	hitboxHeight = 17;
...
void GreyYellow_Enemy_Right_Down::Move()
{
...
void GreyYellow_Enemy_Right_Down::OnCollision(Collider* collider)
{
